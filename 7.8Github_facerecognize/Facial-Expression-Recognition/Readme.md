...
## Visualize for a test image by a pre-trained model ##  成功！！！
...
### Train and Eval model for a fold ###   这里路径不对 没有读到正确的.h5文件
- python mainpro_CK+.py --model VGG19 --bs 128 --lr 0.01 --fold 1

### Train and Eval model for all 10 fold ###
- python k_fold_train.py

### plot confusion matrix for all fold ###  NameError: name 'xrange' is not defined
